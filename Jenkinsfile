pipeline {
    agent any
    environment {
        DOCKER_HUB_REPO = "segundavid/studybuddy"
    ...
    stages {
        stage("Checkout Github") {
            steps {
                ...
                checkout scmGit(branches: [[name: "*/main"]], extensions: [], userRemoteConfigs: [[credentialsId: "github-token", url: "https://github.com/segun-ogundipe/study-buddy.git"]])
            }
        }
